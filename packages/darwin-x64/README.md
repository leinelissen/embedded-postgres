...
![npm](https://img.shields.io/npm/v/@embedded-postgres/darwin-x64)
![npm type definitions](https://img.shields.io/npm/types/@embedded-postgres/darwin-x64)
![npm](https://img.shields.io/npm/dy/@embedded-postgres/darwin-x64)
![NPM](https://img.shields.io/npm/l/@embedded-postgres/darwin-x64)
...
This package contains the `darwin-x64` Postgres binaries for use with the `embedded-postgres`
package. See
...
```sh
npm i @embedded-postgres/darwin-x64
```
...
```ts
import { pg_ctl, initdb, postgres } from '@embedded-postgres/darwin-x64'
