![Embedded Postgres](https://github.com/leinelissen/embedded-postgres/raw/master/docs/images/embedded-postgres-header.svg)

<div align="center">

![npm](https://img.shields.io/npm/v/@embedded-postgres/linux-arm64)
![npm type definitions](https://img.shields.io/npm/types/@embedded-postgres/linux-arm64)
![npm](https://img.shields.io/npm/dy/@embedded-postgres/linux-arm64)
![NPM](https://img.shields.io/npm/l/@embedded-postgres/linux-arm64)
...
This package contains the `linux-arm64` Postgres binaries for use with the `embedded-postgres`
package. See
...
```sh
npm i @embedded-postgres/linux-arm64
```
...
```ts
import { pg_ctl, initdb, postgres } from '@embedded-postgres/linux-arm64'
